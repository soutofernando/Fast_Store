...
const RegisterForm = () => {
    ...
    const { onSubmitRegister, validateSchema, isLogged, logout } = useContext(FireContext)
            ...
            <Formik
                ...
                {({ errors, touched }) => (<Form>
                    <div className='mt-4'>
                        ...
                        />
                        {errors.registerEmail && touched.registerEmail &&
                            <span className='text-red-600 font-mono text-sm font-black flex'><Icon name='X' width={14} height={14} weight={"bold"} className="mt-1 mr-2" />{errors.registerEmail}</span>}
                    </div>
                    <div className='mt-4'>
                    ...
                    <div className='mt-4'>
                        <Button type="submit" onClick={isLogged} className='bg-black text-white p-4 font-mono font-black hover:text-gray-600 '>
